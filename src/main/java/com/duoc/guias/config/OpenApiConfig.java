 ...
 * donde se pega el token JWT emitido por Azure AD (IDaaS).
 */
@Configuration
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("Microservicio Cloud Native para la gestion de guias de despacho. "
                                ...
                                + "Los endpoints de /api/guias requieren un token JWT emitido por Azure AD: "
                                + "obten el token desde Azure (OAuth2), copialo y pegalo en el boton Authorize. "
                                + "Semana 5 - Desarrollo Cloud Native (CDY2204), Duoc UC.")
                ...
                .components(new Components()
                        .addSecuritySchemes(SECURITY_SCHEME, new SecurityScheme()
                                ...
                                .scheme("bearer")
                                .bearerFormat("JWT")
                                .description("Pega aqui el token JWT emitido por Azure AD (sin la palabra Bearer).")));
    }
}
